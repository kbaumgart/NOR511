...
db.run("CREATE TABLE IF NOT EXISTS NJ (ID Text, RoadwayName TEXT, State TEXT, Latitude INTEGER, Longitude INTEGER, ToLatitude INTEGER, ToLongitude INTEGER, Description TEXT, LastUpdate TEXT, County TEXT, Direction TEXT, Notes TEXT, StartDate TEXT, CategoryName TEXT, EndDate TEXT, MessageID INTEGER)");
